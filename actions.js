...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (navbar && hero) {
    ...
    navbar.style.height = `${heroHeight - 10 * rem}px`;
    navbar.style.top = `-${heroHeight - 10 * rem}px`;
  }
});
...
$(function () {
  ...
  const trackUrl = [
    ...
    "./music/Bleeding love.mp3",
    "./music/Highway Don't Care.mp3",
    "./music/Back To December.mp3",
    "./music/The Truth That You Leave.mp3",
    "./music/Croatian Rhapsody.mp3",
  ...
  function selectTrack(flag) {
    ...
    if (currIndex > -1 && currIndex < albumArtworks.length) {
      ...
      currAlbum = trackNames[currIndex];
      currTrackName = albums[currIndex];
